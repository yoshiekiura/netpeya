...
! function (e) {
    ...
    SEMICOLON.initialize = {
        ...
        parallax: function () {
            return "undefined" != typeof skrollr && e.isFunction(skrollr) ? (console.log("parallax: skrollr not Defined."), !0) : void(($.length > 0 || K.length > 0 || Z.length > 0) && (SEMICOLON.isMobile.any() ? ($.addClass("mobile-parallax"), K.addClass("mobile-parallax"), Z.addClass("mobile-parallax")) : skrollr.init({
                forceHeight: !1
            })))
        },
        animations: function () {
        ...
        linkScroll: function () {
            e("a[data-scrollto]").click(function () {
                ...
                return t.parents("#primary-menu").hasClass("on-click") ? !0 : (i || (i = 750), s || (s = SEMICOLON.initialize.topScrollOffset()), n || (n = "easeOutQuad"), e("html,body").stop(!0).animate({
