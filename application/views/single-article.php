...
<head>
  <!-- Title -->
  <title>Blog - Simple Single Article | Xannia - Responsive Website Template</title>
  ...
  <main id="content" role="main">
    ...
    <div class="container u-space-3">
      <div class="w-lg-60 mx-auto">
        ...
        <div class="mb-5">
          <p>At Xannia, our mission has always been focused on bringing openness and transparency to the design process. We've always believed that by providing a space where designers can share ongoing work not only empowers them to make better products, it also helps them grow. We're proud to be a part of creating a more open culture and to continue building a product that supports this vision.</p>
          <p>As we've grown, we've seen how Xannia has helped companies such as Spotify, Microsoft, Airbnb, Facebook, and Intercom bring their designers closer together to create amazing things. We've also learned that when the culture of sharing is brought in earlier, the better teams adapt and communicate with one another.</p>
          <p>That's why we are excited to share that we now have a <a href="#">free version of Xannia</a>, which will allow individual designers, startups and other small teams a chance to create a culture of openness early on.</p>
        </div>

        <h2 class="h5 mb-3">Bringing the culture of sharing to everyone.</h2>

        <div class="mb-9">
          <p>Small teams and individual designers need a space where they can watch the design process unfold, both for themselves and for the people they work with – no matter if it's a fellow designer, product manager, developer or client. Xannia allows you to invite more people into the process, creating a central place for conversation around design. As those teams grow, transparency and collaboration becomes integrated in how they communicate and work together.</p>

          <div class="u-space-1">
            <img class="img-fluid rounded" src="/assets/img/900x600/img1.jpg" alt="Image Description">
          </div>

          <p>"Xannia allows us to collaborate in real time and is a really great way for leadership on the team to stay up-to-date with what everybody is working on," <a href="#">said</a> Stewart Scott-Curran, Intercom's Director of Brand Design.</p>
          <p>We know the power of sharing is real, and we want to create an opportunity for everyone to try Xannia and explore how transformative open communication can be. Now you can have a team of one or two designers and unlimited spectators (think PMs, management, marketing, etc.) share work and explore the design process earlier.</p>
          <p>"Xannia opened a new way of sharing. It's a persistent way for everyone to see and absorb each other's work," said David Scott, Creative Director at <a href="#">Eventbrite</a>.</p>
        </div>
    ...
    <div class="u-bg-img-hero" style="background-image: url(/assets/img/bg-shapes/bg3.png);">
      <div class="container u-space-3">
        ...
        <div class="w-md-80 w-lg-60 text-center mx-auto">
          ...
          <h4 class="h6 text-muted mb-4">Maria Muszynska, Google</h4>
