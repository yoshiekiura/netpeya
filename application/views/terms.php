...
<head>
  <!-- Title -->
  <title>Terms &amp; Conditions | Xannia - Responsive Website Template</title>
      ...
      <div class="container u-space-3">
        <div class="row">
          <div id="stickyBlockStartPoint" class="col-md-4 col-lg-3 mb-7 mb-md-0">
            ...
            <nav class="js-sticky-block bg-primary rounded"
              ...
              <ul id="scrollNav" class="list-unstyled u-list u-list--white py-3 px-5">
                <li class="py-2">
                  <a class="d-block u-list__link" href="#intro">Introduction</a>
                </li>
                <li class="py-2">
                  <a class="d-block u-list__link" href="#services">Using our services</a>
                </li>
                <li class="py-2">
                  <a class="d-block u-list__link" href="#privacy">Privacy and copyright protection</a>
                </li>
                <li class="py-2">
                  <a class="d-block u-list__link" href="#yourContent">Your content in our services</a>
                </li>
              </ul>
            </nav>
            <!-- End Nav -->
          ...
          <div class="col-md-8 col-lg-9">
            <div id="intro" class="u-space-2-bottom">
              <!-- Title -->
              <div class="mb-3">
                <h3 class="text-primary font-weight-bold">Introduction</h3>
              </div>
              <!-- End Title -->

              <!-- Text -->
              <p>Thanks for using our products and services ("Services"). The Services are provided by Pixeel Ltd. ("Xannia"), located at 153 Williamson Plaza, Maggieberg, MT 09514, England, United Kingdom.
            ...
            <div id="services" class="u-space-2">
              <!-- Title -->
              <div class="mb-3">
                <h3 class="text-primary font-weight-bold">Using our services</h3>
              </div>
              <!-- End Title -->
            ...
            <div id="privacy" class="u-space-2">
              <!-- Title -->
              <div class="mb-3">
                <h3 class="text-primary font-weight-bold">Privacy and copyright protection</h3>
              </div>
              <!-- End Title -->

              <!-- Text -->
              <p>Xannia's privacy policies explain how we treat your personal data and protect your privacy when you use our Services. By using our Services, you agree that Xannia can use such data in accordance with our privacy policies.</p>
            ...
            <div id="yourContent" class="u-space-2-top">
              ...
              <p>When you upload, submit, store, send or receive content to or through our Services, you give Xannia (and those we work with) a worldwide license to use, host, store, reproduce, modify, create derivative works (such as those resulting from translations, adaptations or other changes we make so that your content works better with our Services), communicate, publish, publicly perform, publicly display and distribute such content. The rights you grant in this license are for the limited purpose of operating, promoting, and improving our Services, and to develop new ones. This license continues even if you stop using our Services (for example, for a business listing you have added to Xannia Maps). Some Services may offer you ways to access and remove content that has been provided to that Service. Also, in some of our Services, there are terms or settings that narrow the scope of our use of the content submitted in those Services. Make sure you have the necessary rights to grant us this license for any content that you submit to our Services.</p>
              <!-- End Text -->
            </div>
          </div>
        </div>
