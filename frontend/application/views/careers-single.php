...
<head>
  <!-- Title -->
  <title>Careers Single Page | Xannia - Responsive Website Template</title>
...
<body>
  ...
  <main id="content" role="main">
    ...
    <div class="container u-space-4-top">
      <div class="w-lg-80 u-space-2-bottom mx-auto">
        <!-- Jobs Link -->
        <div class="mb-9">
          <a class="text-secondary" href="careers.html">
        ...
        <div class="row justify-content-md-between align-items-md-center mb-7">
          <div class="col-md-9 mb-7 mb-md-0">
            <h1 class="h3 font-weight-bold">Business Strategy Manager</h1>
            <p class="mb-0">Chicago, US, Full Time. <span class="u-label u-label--sm u-label--danger u-label--rounded ml-2">$50k-$75k</span></p>
          </div>
        ...
        <!-- Info -->
        <p>Our team works on global, cross-functional projects that are at the heart of what we do at Xannia. As a member of the business strategy team, you will deliver insights that drive decision-making, execution, and investments for our most critical initiatives. The role will be driving strategic plans, analyzing business performance and implementing operational improvements to scale the business. Success requires analytical savvy, problem-solving sophistication and a dedication to making the highest impact. We are looking for humble, hardworking and collaborative individuals that can think on their feet and thrive in a fast-paced environment.</p>

        <p>We are a lean team, which will provide you opportunities to present directly to our senior leaders. Your impact will be felt immediately!</p>

        <p>Sound interesting? Then come work at Xannia, we're nice! :)</p>
        <!-- End Info -->
      </div>
      ...
      <div class="w-lg-80 u-space-2-top mx-auto">
          ...
          <ul class="list-unstyled mb-0">
            ...
            <li class="py-3">
              <div class="media">
                ...
                <div class="media-body text-secondary">
                  Communicate solutions confidently and effectively across Xannia
                </div>
              </div>
            </li>
            <li class="py-3">
          ...
          <ul class="list-unstyled mb-0">
            <li class="py-3">
              <div class="media">
                ...
                <div class="media-body text-secondary">
                  5+ years of related work experience at a high-performing technology company or management consulting; enterprise experience strongly preferred
                </div>
              </div>
            </li>
            <li class="py-3">
        ...
        <div class="u-space-2-bottom">
          ...
          <ul class="list-unstyled mb-0">
            <li class="py-3">
              <div class="media">
                <div class="d-flex mr-3">
                  <span class="u-icon u-icon-danger--air u-icon--xs rounded-circle">
                    <span class="fa fa-plus u-icon__inner"></span>
                  </span>
                </div>
                <div class="media-body text-secondary">
                  You use Xannia and love emojis
                </div>
              </div>
            </li>
            <li class="py-3">
          ...
          <p>Xannia is where work happens. It connects you with the people and apps you work with every day, no matter where you are or what you do. We believe everyone deserves to work in a welcoming, respectful, and empathetic culture. We live by our values and hire accordingly.</p>

          <p>Launched in February 2014, Xannia is the fastest growing business application ever and is used by thousands of teams and millions of users every day. We currently have eight offices worldwide, in San Francisco, Vancouver, Dublin, Melbourne, New York, London, Tokyo, and Toronto.</p>

          <p>Ensuring a diverse and inclusive workplace where we learn from each other is core to Xannia's values. We welcome people of different backgrounds, experiences, abilities and perspectives. We are an equal opportunity employer and a fun place to work. Come do the best work of your life here at Xannia.</p>
        </div>
      </div>
    </div>
        ...
        <div class="w-lg-80 mx-auto">
          <div id="applyForJob">
            ...
            <div class="text-center mb-7">
              <span class="u-label u-label--sm u-label--white mb-2">Join Xannia</span>
                  ...
                  <div class="js-form-message">
                    <div class="js-focus-state input-group u-form u-form--no-brd">
                      <textarea class="form-control u-form__input" rows="4" required
                                placeholder="How'd you hear about Xannia?"
                                aria-label="How'd you hear about Xannia?"
