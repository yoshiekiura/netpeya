...
<head>
  <!-- Title -->
  <title>Maintenance Mode | Xannia - Responsive Website Template</title>
      ...
      <div class="container">
        ...
        <div class="w-md-80 w-lg-50 text-center mx-auto">
          ...
          <div class="mb-5">
            ...
            <p>We apologize for the inconvenience but Xannia is currently undergoing planned maintenance.</p>
          </div>
          <!-- End Title -->
  ...
  <footer class="u-sticky-footer">
    <div class="container">
      <div class="d-flex justify-content-between align-items-center u-space-1">
        <!-- Copyright -->
        <p class="small text-muted mb-0">&copy; Xannia. 2018 Htmlstream.</p>
        <!-- End Copyright -->
