...
<head>
  <!-- Title -->
  <title>Blog - Classic Right Sidebar | Xannia - Responsive Website Template</title>
          ...
          <div class="ml-auto">
            ...
            <div class="d-inline-block d-sm-none position-relative mr-2">
              ...
              <div id="jumpToDropdown" class="u-unfold mt-2" aria-labelledby="jumpToDropdownInvoker">
                <a class="u-list__link" href="../pages/help.html">Help</a>
                <a class="u-list__link" href="../pages/contacts-agency.html">Contacts</a>
              </div>
            </div>
            <!-- End Jump To -->
            ...
            <div class="d-none d-sm-inline-block ml-sm-auto">
              <ul class="list-inline mb-0">
                <li class="list-inline-item mr-0">
                  <a class="u-header__topbar-nav-link" href="../pages/help.html">Help</a>
                </li>
                <li class="list-inline-item mr-0">
                  <a class="u-header__topbar-nav-link" href="../pages/contacts-agency.html">Contacts</a>
                </li>
              </ul>
            </div>
            <!-- End Links -->
                ...
                <ul id="blogSubMenu" class="list-inline hs-sub-menu u-header__sub-menu py-3 mb-0" style="min-width: 220px;"
                  ...
                  <li class="dropdown-item hs-has-sub-menu">
                    ...
                    <ul id="navSubmenuBlogClassic" class="hs-sub-menu list-unstyled u-header__sub-menu u-header__sub-menu-menu-gutter--y u-header__sub-menu-offset" style="min-width: 220px;"
                      ...
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="classic-left-sidebar.html">Left Sidebar</a>
                      </li>
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="classic-right-sidebar.html">Right Sidebar</a>
                      </li>
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="classic-full-width.html">Full Width</a>
                      </li>
                    </ul>
                    <!-- End Submenu (level 2) -->
                  </li>
                  ...
                  <li class="dropdown-item hs-has-sub-menu">
                    ...
                    <ul id="navSubmenuBlogGrid" class="hs-sub-menu list-unstyled u-header__sub-menu u-header__sub-menu-menu-gutter--y u-header__sub-menu-offset" style="min-width: 220px;"
                      ...
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="grid-left-sidebar.html">Left Sidebar</a>
                      </li>
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="grid-right-sidebar.html">Right Sidebar</a>
                      </li>
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="grid-full-width.html">Full Width</a>
                      </li>
                    </ul>
                    <!-- End Submenu (level 2) -->
                  </li>
                  ...
                  <li class="dropdown-item hs-has-sub-menu">
                    ...
                    <ul id="navSubmenuBlogList" class="hs-sub-menu list-unstyled u-header__sub-menu u-header__sub-menu-menu-gutter--y u-header__sub-menu-offset" style="min-width: 220px;"
                      ...
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="list-left-sidebar.html">Left Sidebar</a>
                      </li>
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="list-right-sidebar.html">Right Sidebar</a>
                      </li>
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="list-full-width.html">Full Width</a>
                      </li>
                    </ul>
                    <!-- End Submenu (level 2) -->
                  </li>
                  ...
                  <li class="dropdown-item hs-has-sub-menu">
                    ...
                    <ul id="navSubmenuBlogCard" class="hs-sub-menu list-unstyled u-header__sub-menu u-header__sub-menu-menu-gutter--y u-header__sub-menu-offset" style="min-width: 220px;"
                      ...
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="modern-left-sidebar.html">Left Sidebar</a>
                      </li>
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="modern-right-sidebar.html">Right Sidebar</a>
                      </li>
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="modern-full-width.html">Full Width</a>
                      </li>
                    </ul>
                    <!-- End Submenu (level 2) -->
                  </li>
                  ...
                  <li class="dropdown-item hs-has-sub-menu">
                    ...
                    <ul id="navSubmenuBlogGridMinimal" class="hs-sub-menu list-unstyled u-header__sub-menu u-header__sub-menu-menu-gutter--y u-header__sub-menu-offset" style="min-width: 220px;"
                      ...
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="masonry-left-sidebar.html">Left Sidebar</a>
                      </li>
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="masonry-right-sidebar.html">Right Sidebar</a>
                      </li>
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="masonry-full-width.html">Full Width</a>
                      </li>
                    </ul>
                    <!-- End Submenu (level 2) -->
                  </li>
                  ...
                  <li class="dropdown-item hs-has-sub-menu">
                    ...
                    <ul id="navSubmenuBlogGridMasonry" class="hs-sub-menu list-unstyled u-header__sub-menu u-header__sub-menu-menu-gutter--y u-header__sub-menu-offset" style="min-width: 220px;"
                      ...
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="single-article-classic.html">Classic</a>
                      </li>
                      <li class="dropdown-item px-0">
                        <a class="nav-link u-list__link px-4" href="single-article-simple.html">Simple</a>
                      </li>
                    </ul>
                    <!-- End Submenu (level 2) -->
                  </li>
  ...
  <main id="content" role="main">
    ...
    <div class="container u-space-4-top u-space-5-top--md u-space-4-top--lg u-space-3-bottom">
      ...
      <div class="w-md-80 w-lg-60 mb-9">
        <h1 class="font-weight-normal">Blog classic - <span class="text-primary font-weight-bold">Right Sidebar</span></h1>
      </div>
      <!-- End Title -->
      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 mb-7">
              ...
              <article>
                ...
                <h3 class="h5">
                  <a href="single-article-classic.html">5 basic tips for colors</a>
                </h3>
            ...
            <div class="col-sm-6 mb-7">
              ...
              <article>
                <div class="mb-5">
                  <img class="img-fluid rounded" src="/assets/img/500x280/img16.jpg" alt="Image Description">
                </div>
                <small class="d-block text-secondary mb-1">March 20, 2018</small>
                <h3 class="h5">
            ...
            <div class="col-sm-6 mb-7">
              ...
              <article>
                <div class="mb-5">
                  <img class="img-fluid rounded" src="/assets/img/500x280/img21.jpg" alt="Image Description">
                </div>
                <small class="d-block text-secondary mb-1">April 1, 2018</small>
                <h3 class="h5">
                  <a href="single-article-classic.html">Create your adventure</a>
                </h3>
            ...
            <div class="col-sm-6 mb-7">
              ...
              <article>
                <div class="mb-5">
                  <img class="img-fluid rounded" src="/assets/img/500x280/img10.jpg" alt="Image Description">
                </div>
                <small class="d-block text-secondary mb-1">March 18, 2018</small>
                <h3 class="h5">
                  <a href="single-article-classic.html">Announcing a free plan for small teams</a>
                </h3>
            ...
            <div class="col-sm-6 mb-7">
              ...
              <article>
                <div class="mb-5">
                  <img class="img-fluid rounded" src="/assets/img/500x280/img17.jpg" alt="Image Description">
                </div>
                <small class="d-block text-secondary mb-1">March 18, 2018</small>
                <h3 class="h5">
            ...
            <div class="col-sm-6 mb-7">
              ...
              <article>
                <div class="mb-5">
                  <img class="img-fluid rounded" src="/assets/img/500x280/img18.jpg" alt="Image Description">
                </div>
                <small class="d-block text-secondary mb-1">April 29, 2018</small>
                <h3 class="h5">
                  <a href="single-article-classic.html">Classic design principles</a>
                </h3>
                <p>Sailing here was a surreal experience. The light fog snaked its way through the valley, but still let the sun warm our backs.</p>
              </article>
              <!-- End News Classic -->
            </div>
            ...
            <div class="col-sm-6 mb-7">
              ...
              <article>
                <div class="mb-5">
                  <img class="img-fluid rounded" src="/assets/img/500x280/img19.jpg" alt="Image Description">
                </div>
                <small class="d-block text-secondary mb-1">April 1, 2018</small>
                <h3 class="h5">
                  <a href="single-article-classic.html">InVision design forward fund</a>
                </h3>
                <p>Fewer bumps in the road: ClearMotion is a new technology that does to your ride what noise cancelling does to your headphones.</p>
              </article>
              <!-- End News Classic -->
            </div>
            ...
            <div class="col-sm-6 mb-7">
              ...
              <article>
                <div class="mb-5">
                  <img class="img-fluid rounded" src="/assets/img/500x280/img22.jpg" alt="Image Description">
                </div>
                <small class="d-block text-secondary mb-1">April 1, 2018</small>
                <h3 class="h5">
                  <a href="single-article-classic.html">Smartbtc sees the need for contracts</a>
                </h3>
                <p>Guess what. We're sponsoring the February edition of CreativeMornings/New York.</p>
              </article>
              <!-- End News Classic -->
            </div>
            ...
            <div class="col-sm-6 mb-7">
              ...
              <article>
                <div class="mb-5">
                  <img class="img-fluid rounded" src="/assets/img/500x280/img2.jpg" alt="Image Description">
                </div>
                <small class="d-block text-secondary mb-1">April 1, 2018</small>
                <h3 class="h5">
                  <a href="single-article-classic.html">We're cultured</a>
                </h3>
        ...
        <div id="stickyBlockStartPoint" class="col-lg-3">
          ...
          <div class="js-sticky-block"
            ...
            <h3 class="h5 text-primary font-weight-bold mb-4">News</h3>
            ...
            <h3 class="h5 text-primary font-weight-bold mb-4">Tags</h3>

            <!-- Tags -->
            <ul class="list-inline mb-0">
              <li class="list-inline-item pb-3">
                <a class="u-label u-label--xs u-label--secondary" href="#">Design</a>
              </li>
              <li class="list-inline-item pb-3">
                <a class="u-label u-label--xs u-label--secondary" href="#">Art</a>
              </li>
              <li class="list-inline-item pb-3">
                <a class="u-label u-label--xs u-label--secondary" href="#">Graphic</a>
              </li>
              <li class="list-inline-item pb-3">
                <a class="u-label u-label--xs u-label--secondary" href="#">CSS</a>
              </li>
              <li class="list-inline-item pb-3">
                <a class="u-label u-label--xs u-label--secondary" href="#">HTML</a>
              </li>
              <li class="list-inline-item pb-3">
                <a class="u-label u-label--xs u-label--secondary" href="#">SASS</a>
              </li>
              <li class="list-inline-item">
                <a class="u-label u-label--xs u-label--secondary" href="#">WordPress</a>
              </li>
            </ul>
            <!-- End Tags -->
            ...
            <h3 class="h5 text-primary font-weight-bold mb-4">Instagram</h3>
            ...
            <div id="instaFeed" class="js-instagram row mx-gutters-2"
                 ...
                 data-token="4815936096.1677ed0.38fff3811a8749d3b91fc79b391542cb"
                 data-limit="4"
                 data-template='<div class="col-3"><a href="{{link}}" target="_blank"><img class="img-fluid w-100 rounded" src="{{image}}" /></a></div>'></div>
            <!-- End Instafeed -->
          </div>
          <!-- End Sticky Block -->
        </div>
        ...
        <div class="row justify-content-md-center">
          <div class="col-md-9 col-lg-7 col-xl-6 offset-xl-2">
            ...
            <div class="text-center mb-4">
              ...
              <p class="lead u-text-light">Get special offers on the latest developments from Xannia.</p>
            </div>
            <!-- End Title -->
            ...
            <form class="js-validate js-form-message mb-2">
              <div class="js-focus-state input-group input-group-lg u-form u-form--lg u-form--white-brd">
                ...
                <div class="input-group-append u-form__append">
                  <button type="submit" class="btn btn-warning u-btn-wide">Join Xannia</button>
                </div>
              </div>
            </form>
            <!-- End Form -->
