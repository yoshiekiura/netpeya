...
$config['environment'] = ($_SERVER['HTTP_HOST'] == 'member.xanniapay.com' || $_SERVER['HTTP_HOST'] == 'localhost') ? 'development' : 'production';

$config['base_url'] = $config['protocol'].$_SERVER['HTTP_HOST'].'/';


$config['member_backend_url'] = 'http://app.xannia.com/';
