        ...
        <div class="container">
            <div class="col-md-12">
                <section class="content-header">
                    <h1>Payouts Report - advanced search <span class="line"></span></h1>
                </section>
                <form id="advanced_search_form" action="/payouts/report" method="post">
                    <div class="col-md-3 no-left">
                        <h3 class="form-title black-text">Payout Status</h3>
                    ...
                    <div class="col-md-3">
                        <h3 class="form-title black-text">Payout Method</h3>
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <h3 class="form-title black-text">Payout date</h3>
                        <div class="form-group">
                    ...
                    <div class="col-md-12 no-right">
                        <div class="form-group top-30 text-center">
                            <button id="advanced_search_btn" class="btn btn-success">Search Payouts <i class="fa fa-search"></i></button>
                        </div>
                    </div>
                </form>
            </div>
