...
$config['environment'] = '';
$config['shared_resources_source'] = '';

switch ($_SERVER['HTTP_HOST']) {
    case 'local.xannia.com':
    case 'local.wallet.xannia.com':
    case 'local.merchant.xannia.com':
    case 'local.api.xannia.com':
    case 'local.backend.xannia.com':
        $config['environment'] = 'development';
        $config['shared_resources_source'] = 'http://local.xannia.com/assets/shared/';
        break;

    default:
        $config['environment'] = 'production';
        $config['shared_resources_source'] = 'http://xannia.com/assets/shared/';
        break;
}
...
$config['pagination'] = array(
    'base_url' => $config['base_url'] . 'sales/report',
    'total_rows' => 0,
    'per_page' => 30,
    "uri_segment" => 3,
    'num_links' => 3,
    ...
    'last_tag_close' => '</span>',
    'next_link' => '',
    'next_tag_open' => '<span class="pagination-btn pagination-next">',
    'next_tag_close' => '</span>',
    'prev_link' => '',
    'prev_tag_open' => '<span class="pagination-btn pagination-prev">',
    'prev_tag_close' => '</span>',
    'cur_tag_open' => '<span class="pagination-btn active">',
    'cur_tag_close' => '</span>',
