        ...
        <div class="deposit-form p-3">
            <form class="form" method="post" action="/deposit/pay">
                ...
                <div class="form-group">
                    ...
                    <button id="deposit_continue_btn" class="btn btn-submit btn-green">Continue - <?= $user->currency_simbol ?><span id="btn_deposit_amount" class="btn-amount"><?= $default_payment_with_charges ?></span></button>
                </div>
            </form>
        </div>
    </div>
