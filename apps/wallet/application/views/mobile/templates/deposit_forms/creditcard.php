        ...
        <div class="card-side card-front">
            ...
            <div class="form-group card-expiration">
                ...
                <div class="expiration-fields advanced-form-input" date-focus="">
                    <div class="advanced-form-input-wrapper">
                        <input type="text" id="card-exp-month" name="cc_exp_month" class="cc_exp_month form-control expiration-fields__input" tabindex="3" maxlength="2" placeholder="MM">
                    </div>
                    <div class="advanced-form-input-wrapper">
                        <input type="text" id="card-exp-year" tabindex="4" maxlength="4" name="cc_exp_year" class="cc_exp_year form-control expiration-fields__input" placeholder="YYYY">
                    </div>
                </div>
            </div>
            <div class="form-group">
