...
<div style="width: 100%">
	<p style="text-align: center;">Hi <strong><?= $first_name != '' ? $first_name . ' ' . $last_name : $email ?></strong></p>
	...
	<p style="max-width: 500px; margin: 0 auto;text-align: center;font-size: 30px; font-weight: bold; letter-spacing: 10px;"><?= $activation_code ?></p>
</div>
